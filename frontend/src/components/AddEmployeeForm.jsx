import { useState, DatePicker, PasswordToggle } from "../constants/imports";
import "react-datepicker/dist/react-datepicker.css";
import useAddEmployee from "../hooks/useAddEmployee";

const AddEmployeeForm = ({ refreshEmployees }) => {

    const { handleAddEmployee, loading } = useAddEmployee(refreshEmployees);
                ...
                <form onSubmit={handleAddEmployee} className="w-full bg-[#1B211A] p-10 rounded-2xl border border-[#FFDAB3]/40 shadow-[0_0_40px_rgba(0,0,0,0.6)] flex flex-wrap gap-8">
                    ...
                    <div className="w-full md:w-[48%] flex flex-col gap-6">
                        <div>
                            ...
                            <input name="firstName" required className="mt-2 w-full bg-[#0F1412] border border-[#FFDAB3]/30 rounded-2xl px-4 py-3 text-[#F8F8F2] outline-none focus:border-[#FFDAB3] focus:ring-1 focus:ring-[#FFDAB3]/50 transition" placeholder="Enter your first name" />
                        </div>

                        <div>
                            <label className="text-md uppercase tracking-wide text-[#FFDAB3]/80"> Email Address </label>
                            <input name="email" type="email" required className="mt-2 w-full bg-[#0F1412] border border-[#FFDAB3]/30 rounded-2xl px-4 py-3 text-[#F8F8F2] outline-none focus:border-[#FFDAB3] focus:ring-1 focus:ring-[#FFDAB3]/50 transition" placeholder="Enter your email" />
                        </div>
                    ...
                    <div className="w-full md:w-[48%] flex flex-col gap-6">
                        <div>
                            ...
                            <input name="lastName" required className="mt-2 w-full bg-[#0F1412] border border-[#FFDAB3]/30 rounded-2xl px-4 py-3 text-[#F8F8F2] outline-none focus:border-[#FFDAB3] focus:ring-1 focus:ring-[#FFDAB3]/50 transition" placeholder="Enter your last name" />
                        </div>
                        ...
                        <div>
                            ...
                            <input name="designation" required className="mt-2 w-full bg-[#0F1412] border border-[#FFDAB3]/30 rounded-2xl px-4 py-3 text-[#F8F8F2] outline-none focus:border-[#FFDAB3] focus:ring-1 focus:ring-[#FFDAB3]/50 transition" placeholder="Enter your designation" />
                        </div>
                    </div>
