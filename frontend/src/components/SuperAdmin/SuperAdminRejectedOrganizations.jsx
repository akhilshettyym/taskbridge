...
import useSuperAdminRejectedOrganizations from "../../hooks/SuperAdminHooks/useSuperAdminRejectedOrganizations";

const SuperAdminRejectedOrganizations = () => {

  const { loadingId, fetchAllOrganization, allEmployees, fetchAllEmployees, rejectedOrganizations, getCountryName, handleDeleteRejectedOrgs } = useSuperAdminRejectedOrganizations();
