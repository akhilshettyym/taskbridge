...
const SuperAdminEmployeesControl = () => {
        ...
        <div className="mt-6">
            <div className="bg-[#626F47]/35 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-md">
                <div className="flex flex-wrap items-center gap-3">
                    <h1 className="ml-5 mr-5 text-[#FFDAB3] text-sm uppercase font-semibold"> Employees </h1>
                    {navItems.map((item) => {
...
export default SuperAdminEmployeesControl;