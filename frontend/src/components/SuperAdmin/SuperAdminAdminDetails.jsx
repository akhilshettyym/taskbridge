...
const SuperAdminAdminDetails = ({ admins = [], refreshAdmins }) => {
    ...
    const { selectedAdmin, showUpdateModal, setShowUpdateModal, localAdmins, setLocalAdmins, removingId, handleUpdateClick, handleRefresh, handleRemoveAdmin } = useSuperAdminAdminDetails({ admins, refreshAdmins });
