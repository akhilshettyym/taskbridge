 ...
 const getButtons = () => {
   switch (status) {
     case "new":
       return (
         <div className="grid grid-cols-2 gap-3 w-full">
           <button onClick={handleAcceptTask} className="py-2 px-6 rounded-sm text-sm font-semibold bg-green-500 text-white border border-green-500 uppercase hover:bg-green-700 transition-colors">
             Accept Task
           </button>
           <button onClick={() => setShowFailModal(true)} className="py-2 px-6 rounded-sm text-sm font-semibold bg-red-500 text-white border border-red-500 uppercase hover:bg-red-700 transition-colors">
             Reject Task
           </button>
         </div>
       );
     ...
     case "inprogress":
       return (
         <div className="grid grid-cols-2 gap-3 w-full">
           <button onClick={handleComplete} className="px-6 rounded-sm text-xs font-semibold bg-green-500 text-white border border-green-500 uppercase hover:bg-green-700 transition-colors">
             Mark as Completed
           </button>
           <button onClick={() => setShowFailModal(true)} className="px-6 rounded-sm text-xs font-semibold bg-red-500 text-white border border-red-500 uppercase hover:bg-red-700 transition-colors">
             Mark as Failed
           </button>
         </div>
       );
     ...
     case "completed":
       return (
         <div className="grid gap-3 w-full">
           <button className="py-2 px-6 rounded-sm text-sm font-semibold text-green-500 border border-green-500 uppercase" disabled>
             Completed
           </button>
         </div>
       );
     ...
     case "failed":
       return (
         <div className="grid gap-3 w-full">
           <button className="py-2 px-6 rounded-sm text-sm font-semibold text-red-500 border border-red-500 uppercase" disabled>
             Failed
           </button>
         </div>
       );
